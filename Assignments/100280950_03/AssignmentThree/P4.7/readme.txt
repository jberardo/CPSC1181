The following pseudocode describes how to turn a string	containing a ten-digit
	phone number (such as "4155551212" ) into a more readable string with
	parentheses and dashes, like this: "(415) 555-1212".
...
Reads a telephone number into a string variable, com­putes the formatted number, and prints it.