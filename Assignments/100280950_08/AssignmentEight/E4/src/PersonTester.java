...
public class PersonTester
{
	public static void main(String[] args)
	{
		...
		System.out.println("Expected: 176.20\n");
		...
		// largest person
		System.out.println("Largest: " + Measurable.largest(meas));
		System.out.println("Expected: Name[P7], Height[193]\n");
		
		// smallest person
		System.out.println("Smallest: " + Measurable.smallest(meas));
		System.out.println("Expected: Name[P5], Height[165]\n");
	}
	
	public static Measurable[] init()
	{
		// create some Person objects
		Person p1 = new Person("P1", 179);
