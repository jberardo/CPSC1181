...
public class State
{
	...
	/**
	 * Sets the State's zip code list
	 * @param zipCode State's zip code list
	 */
	...
	/**
	 * Returns a string representation of the State<br>
	 * String contains name, abbreviation and a list of zip codes
	 */
