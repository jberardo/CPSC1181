...
/**
 * Create a drivers license with name and expiration year
 * 
 * @author Joao Berardo
...
public class DriverLicense extends Card {
	...
	/**
	 * Retrieves driver license expiration year
	 * @param expirationYear driver license expiration year
	 */
	...
	/**
	 * Checks if the driver license is expired or not
