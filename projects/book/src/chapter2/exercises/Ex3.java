...
public class Ex3 {
	...
	public static void main(String[] args) {
		String msg = "Mississipi";
		
		System.out.println("Default string: " + msg);
		System.out.println();
		
		String newMsg = msg.replace("i","ii");

		System.out.println("Replace 'i' for 'ii': " + newMsg);
		System.out.println("Length: " + newMsg.length());
		
		System.out.println();
		
		newMsg =  msg.replace("s","ss"); 
		
		System.out.println("Replace 's' for 'ss': " + newMsg);
		System.out.println("Length: " + newMsg.length());
	}
}
